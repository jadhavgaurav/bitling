...
- **CR7** (Cristiano Ronaldo) features a crisp, realistic likeness with a completely unattached free soccer ball that rolls, bounces, and reacts to clicks. He chases down the ball, dribbles, juggles, snipes bugs by launching power-kick strikes directly at them, and celebrates every code push / deployment with a theatrical **"GOAL!"** sequence (stadium net, top-bins net bulge, referee whistle, crowd roar, golden confetti, and the iconic mid-air spin landing **"SIUUUU!"**).
