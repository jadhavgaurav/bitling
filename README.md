...
| <img src="web/avatars/ronaldo.png" width="48" height="48" alt="CR7"> | **CR7**<br><sub>Cristiano Ronaldo</sub> | Walker | Dribbles and juggles a soccer ball along the dock, lightning footwork and high-knee sprints | Blasts curving knuckleballs at small bugs; jumps high in mid-air to unleash the iconic supersonic SIUUU strike on bosses |
...
- **CR7** (Cristiano Ronaldo) dribbles a soccer ball along your dock, takes the wide-stance free-kick stance with a golden aura, snipes small pests with dipping Knuckleballs, and executes the world-famous mid-air leap and landing **"SIUUUU!"** shockwave celebration ("Top bins!", "GOLAZO!", "Insha'Allah... SIUUU!").
